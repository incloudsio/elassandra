...
if "public static final String INDEX_OPAQUE_STORAGE" in text:
    print("ClusterService index-settings keys already present:", path)
    raise SystemExit(0)

# Insert after SETTING_SYSTEM_SYNCHRONOUS_REFRESH line from elassandra-stubs, or after replicationFactor stub.
...
print("Added ElassandraIndexSettings ClusterService keys:", path)
PY
