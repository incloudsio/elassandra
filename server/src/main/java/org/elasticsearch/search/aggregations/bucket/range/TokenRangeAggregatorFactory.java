...
/**
 * Marker subclass of {@link RangeAggregatorFactory} for {@code token_range} aggregations (see
 * {@link org.elassandra.search.aggregations.bucket.token.TokenRangeAggregationBuilder}).
 */
public class TokenRangeAggregatorFactory extends RangeAggregatorFactory {

    public TokenRangeAggregatorFactory(String name, ValuesSourceConfig<Numeric> config, Range[] ranges, boolean keyed,
