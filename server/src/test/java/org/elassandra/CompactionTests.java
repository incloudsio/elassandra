...
public class CompactionTests extends ESSingleNodeTestCase {
    ...
    public void basicCompactionTest() throws Exception {
        ...
        assertThat(client().prepareSearch().setIndices(firstIndex).setTypes("t1").setQuery(QueryBuilders.matchAllQuery()).get().getHits().getTotalHits(), equalTo(100L));
        assertThat(client().prepareSearch().setIndices(secondIndex).setTypes("t2").setQuery(QueryBuilders.matchAllQuery()).get().getHits().getTotalHits(), equalTo(2*100L));
        ...
        assertThat(client().prepareSearch().setIndices(firstIndex).setTypes("t1").setQuery(QueryBuilders.matchAllQuery()).get().getHits().getTotalHits(), equalTo(200L));
        assertThat(client().prepareSearch().setIndices(secondIndex).setTypes("t2").setQuery(QueryBuilders.matchAllQuery()).get().getHits().getTotalHits(), equalTo(2*200L));
        StorageService.instance.forceKeyspaceFlush(firstIndex,"t1");
        StorageService.instance.forceKeyspaceFlush(secondIndex,"t2");
        Thread.sleep(200);
        ...
        assertThat(client().prepareSearch().setIndices(firstIndex).setTypes("t1").setQuery(QueryBuilders.matchAllQuery()).get().getHits().getTotalHits(), equalTo(300L));
        assertThat(client().prepareSearch().setIndices(secondIndex).setTypes("t2").setQuery(QueryBuilders.matchAllQuery()).get().getHits().getTotalHits(), equalTo(2*300L));
        ...
        assertThat(client().prepareSearch().setIndices(firstIndex).setTypes("t1").setQuery(QueryBuilders.matchAllQuery()).get().getHits().getTotalHits(), equalTo(300L));
        assertThat(client().prepareSearch().setIndices(firstIndex).setTypes("t1").setQuery(QueryBuilders.queryStringQuery("b:y")).get().getHits().getTotalHits(), equalTo(100L));
        
        assertThat(client().prepareSearch().setIndices(secondIndex).setTypes("t2").setQuery(QueryBuilders.matchAllQuery()).get().getHits().getTotalHits(), equalTo(2*300L));
        assertThat(client().prepareSearch().setIndices(secondIndex).setTypes("t2").setQuery(QueryBuilders.queryStringQuery("b:y")).get().getHits().getTotalHits(), equalTo(300L));
        ...
        assertThat(client().prepareSearch().setIndices(firstIndex).setTypes("t1").setQuery(QueryBuilders.matchAllQuery()).get().getHits().getTotalHits(), equalTo(200L));
        assertThat(client().prepareSearch().setIndices(firstIndex).setTypes("t1").setQuery(QueryBuilders.queryStringQuery("b:y")).get().getHits().getTotalHits(), equalTo(0L));

        assertThat(client().prepareSearch().setIndices(secondIndex).setTypes("t2").setQuery(QueryBuilders.matchAllQuery()).get().getHits().getTotalHits(), equalTo(2*200L));
        assertThat(client().prepareSearch().setIndices(secondIndex).setTypes("t2").setQuery(QueryBuilders.queryStringQuery("b:y")).get().getHits().getTotalHits(), equalTo(200L));
    ...
    public void expiredTtlCompactionTest() throws Exception {
        ...
        assertThat(client().prepareSearch().setIndices(index).setTypes("t1").setQuery(QueryBuilders.matchAllQuery()).get().getHits().getTotalHits(), equalTo(N));
        ...
        assertThat(client().prepareSearch().setIndices(index).setTypes("t1").setQuery(QueryBuilders.matchAllQuery()).get().getHits().getTotalHits(), equalTo(2*N));
        assertThat(client().prepareSearch().setIndices(index).setTypes("t1").setQuery(QueryBuilders.queryStringQuery("b:y")).get().getHits().getTotalHits(), equalTo(N));
        StorageService.instance.forceKeyspaceFlush(index,"t1");
        Thread.sleep(2000);
        ...
        assertThat(client().prepareSearch().setIndices(index).setTypes("t1").setQuery(QueryBuilders.matchAllQuery()).get().getHits().getTotalHits(), equalTo(3*N));
        assertThat(client().prepareSearch().setIndices(index).setTypes("t1").setQuery(QueryBuilders.queryStringQuery("b:y")).get().getHits().getTotalHits(), equalTo(N));
        ...
        assertThat(client().prepareSearch().setIndices(index).setTypes("t1").setQuery(QueryBuilders.matchAllQuery()).get().getHits().getTotalHits(), equalTo(2*N));
        assertThat(client().prepareSearch().setIndices(index).setTypes("t1").setQuery(QueryBuilders.queryStringQuery("b:y")).get().getHits().getTotalHits(), equalTo(0L));
    }
    ...
    public void expiredTtlColumnCompactionTest() throws Exception {
        ...
        assertThat(client().prepareSearch().setIndices(index).setTypes("t1").setQuery(QueryBuilders.matchAllQuery()).get().getHits().getTotalHits(), equalTo(2*N));
        assertThat(client().prepareSearch().setIndices(index).setTypes("t1").setQuery(QueryBuilders.wildcardQuery("b", "*")).get().getHits().getTotalHits(), equalTo(2*N));
        StorageService.instance.forceKeyspaceFlush(index,"t1");
        assertThat(gauges.get("org.apache.cassandra.metrics.Table.LiveSSTableCount." + index + ".t1").getValue(), equalTo(2));
        ...
        Thread.sleep(20*1000);  // wait gc_grace_seconds expiration
        assertThat(client().prepareSearch().setIndices(index).setTypes("t1").setQuery(QueryBuilders.matchAllQuery()).get().getHits().getTotalHits(), equalTo(2*N));
        assertThat(client().prepareSearch().setIndices(index).setTypes("t1").setQuery(QueryBuilders.wildcardQuery("c","*")).get().getHits().getTotalHits(), equalTo(N));
        assertThat(client().prepareSearch().setIndices(index).setTypes("t1").setQuery(QueryBuilders.wildcardQuery("b","*")).get().getHits().getTotalHits(), equalTo(2*N));
        ...
        assertThat(client().prepareSearch().setIndices(index).setTypes("t1").setQuery(QueryBuilders.matchAllQuery()).get().getHits().getTotalHits(), equalTo(N));
        assertThat(client().prepareSearch().setIndices(index).setTypes("t1").setQuery(QueryBuilders.wildcardQuery("c","*")).get().getHits().getTotalHits(), equalTo(N));
        assertThat(client().prepareSearch().setIndices(index).setTypes("t1").setQuery(QueryBuilders.wildcardQuery("b","*")).get().getHits().getTotalHits(), equalTo(N));
    }
