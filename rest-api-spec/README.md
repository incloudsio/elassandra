...
Example for the ["Create Index"](https://docs.opensearch.org/latest/api-reference/index-apis/create-index/) API:

```json
{
  "indices.create": {
    "documentation":{
      "url":"https://docs.opensearch.org/latest/api-reference/index-apis/create-index/"
    },
    "stability": "stable",
    "url":{
      "paths":[
...
* Link to the documentation at the <https://docs.opensearch.org/> website.
  ...
  **IMPORANT:** This should be a _live_ link. Several downstream ES clients use
  ...
  yet-to-be-created doc pages can break downstream docs generation pipelines.
