...
2.  Is this bug report or feature request for a supported OS? If not, it
    is likely to be closed.  See https://opensearch.org/docs/latest/install-and-configure/install-opensearch/index/
...
* opensearch cluster state (curl http://localhost:9200/_cluster/state)
